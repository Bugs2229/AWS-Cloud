...
variable "project_name" {
  ...
  type        = string
  default     = "Armegadon" # TODO: student supplies
}
...
variable "ec2_ami_id" {
  ...
  type        = string
  default     = "ami-02dc6e3e481e2bbc5" # TODO
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "Ving07Tsun" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "ladorian@hotmail.com" # TODO: student supplies
}
